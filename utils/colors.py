...
# 主要 色盘：--------------------------------------------------
primaryColors = ['#8870ad','#647a4f','#C72228','#B51D8D','#139992','#FBBE92','#EF5A9D','#ff891c',"#15ACEC",'#8EC792','#CDE088','#3F84AA','#cc7818','#65A83E','#C3C388',"#f8887e",'#f9decf','#EF4E22','#8DB5CE','#c9a997','#FACB12','#F397C0','#c19f70','#DFCDE4','#C594BF','#DABE99','#f6bfcb']
...
# COLORS_60 色盘 ------------------------------------------------
COLORS_60 = [
    "#c0301d", "#b4cab9", "#94338a", "#4682B4", "#00CED1", "#49784e", "#DEB887", "#ffffb3", "#FF6347", "#483D8B", 
    ...
    "#008B8B", "#4B0082", "#5F9EA0", "#BDB76B", "#000000", "#FFA500", "#708090", "#FF7F50", "#B8860B", 
    "#006400", "#556B2F", "#E9967A", "#8FBC8F", "#008000", "#696969",
    "#00BFFF", "#1E90FF", "#B22222", "#228B22", "#A52A2A",
    "#20B2AA", "#a23919", "#9b7d24", "#443645", "#39607d", "#e6dbcb", "#355b6e", "#423e55", "#b0b173", "#376d78", 
    "#2d5aa2", "#486343", "#552141", "#1166FF"]
